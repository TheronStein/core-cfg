...
# History options - CONSOLIDATED (no duplicates)
...
setopt share_history          # imports commands and appends (can't use with inc_append_history)
...
# setopt monitor              # enable job control (can't change in non-interactive)
...
# # Core Zsh options - loaded first for consistency
#
...
# setopt rc_quotes           # allow '' in single quotes for one '
#
