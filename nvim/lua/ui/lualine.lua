...
return {
  ...
  -- Second plugin: lualine.nvim
  {
    ...
    config = function()
      ...
      local extended = require("mods.lualine-extended")
      ...
      require("lualine").setup({
        ...
        sections = {
          lualine_a = {
            "mode",
            extended.macro_recording
          },
          lualine_b = {
            extended.git_status,
            extended.diagnostics_detailed,
          },
          lualine_c = {
            keymap,
            extended.current_function,
            extended.python_env,
            "filename",
          },
          lualine_x = {
            extended.notification_count,
