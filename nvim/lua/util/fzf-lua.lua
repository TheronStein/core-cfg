      ...
      fzf.setup({
        ...
        winopts = {
          ...
          on_create = function()
            ...
            vim.keymap.set("t", "<C-w>", "<Up>", { silent = true, buffer = true })
            vim.keymap.set("t", "<C-s>", "<Down>", { silent = true, buffer = true })
            vim.keymap.set("t", "<C-a>", "<Left>", { silent = true, buffer = true })
            vim.keymap.set("t", "<C-d>", "<Right>", { silent = true, buffer = true })
          end,
        },
