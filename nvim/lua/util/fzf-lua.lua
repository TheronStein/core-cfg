...
return {
  {
    ...
    config = function()
      ...
      -- Configuration with Snacks-like UI styling
      fzf.setup({
        -- Global options
        global_resume = true,
        ...
        winopts = {
          ...
          row = 0.35,
          col = 0.50,
          border = "double", -- Match snacks double border
          fullscreen = false,
          title = "   CORE - FZF  ", -- Decorative title like snacks
          title_pos = "center",
          -- Window highlights similar to snacks picker
          hls = {
            normal = "Normal",
            border = "FloatBorder",
            cursor = "Cursor",
          ...
          on_create = function()
            -- Add custom keymaps for the fzf window (WASD navigation)
            vim.keymap.set("t", "<C-w>", "<PageUp>", { silent = true, buffer = true })
            vim.keymap.set("t", "<C-s>", "<PageDown>", { silent = true, buffer = true })
            vim.keymap.set("t", "<C-o>", "<PageUp>", { silent = true, buffer = true })
            vim.keymap.set("t", "<C-u>", "<PageDown>", { silent = true, buffer = true })
            -- Add custom keymaps for the fzf window (WASD navigation)
            vim.keymap.set("t", "<C-i>", "<Up>", { silent = true, buffer = true })
            vim.keymap.set("t", "<C-k>", "<Down>", { silent = true, buffer = true })
            vim.keymap.set("t", "<C-j>", "<Left>", { silent = true, buffer = true })
            vim.keymap.set("t", "<C-l>", "<Right>", { silent = true, buffer = true })
          end,
        },
        ...
        git = {
          ...
          branches = {
            ...
            actions = {
              ...
              ["ctrl-n"] = { fn = fzf.actions.git_branch_add, reload = true },
            },
          },
          stash = {
            prompt = "Stash❯ ",
