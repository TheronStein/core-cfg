...
function M.setup()
  ...
  wk.add({
    ...
    },
    {
      "<leader><tab>m",
      function()
        fzf_coreline().tab_manager()
      end,
      desc = "Tab manager (fzf)",
    },
  ...
  wk.add({
    ...
    { "<leader>bw", "<cmd>bwipeout<cr>", desc = "Wipeout buffer" },
    {
      ...
      desc = "Close other buffers (in scope)",
    },
    {
      "<leader>bh",
      function()
    ...
    -- Scope operations
    {
      "<leader>bm",
      function()
        fzf_coreline().buffer_manager()
      end,
      desc = "Buffer manager (fzf)",
    },
    {
      "<leader>bs",
      function()
        fzf_coreline().scoped_buffers()
      end,
      desc = "Pick buffer (in scope)",
    },
    {
      "<leader>bS",
      function()
      ...
      desc = "Toggle scope view (all/scoped)",
    },
    {
      "<leader>ba",
      function()
    ...
    },
    {
      ...
      desc = "Remove buffer from scope",
    },
    -- Move/Copy between tabs
    {
      "<leader>bt",
      function()
        fzf_coreline().move_buffer_to_tab()
      end,
    ...
    },
    {
      "<leader>by",
      function()
        fzf_coreline().copy_buffer_to_tab()
      end,
      desc = "Copy buffer to tab",
    },
  ...
  vim.keymap.set("n", "<C-e>", function()
    nav().next()
  end, { desc = "Next buffer (in scope)", silent = true })
  vim.keymap.set("n", "<C-q>", function()
    nav().prev()
  end, { desc = "Previous buffer (in scope)", silent = true })
end
