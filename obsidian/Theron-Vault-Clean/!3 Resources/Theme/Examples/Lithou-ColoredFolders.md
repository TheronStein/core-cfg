...
    .nav-folder.mod-root>.nav-folder-children>.nav-folder>.nav-folder-title[data-path^="I"],

    .nav-folder.mod-root>.nav-folder-children>.nav-folder>.nav-folder-title[data-path^="I"] + .nav-folder-children{
