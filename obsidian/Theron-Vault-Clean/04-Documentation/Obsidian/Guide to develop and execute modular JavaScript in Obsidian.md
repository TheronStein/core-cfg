...
[dataview](https://forum.obsidian.md/tag/dataview)[ui-ux](https://forum.obsidian.md/tag/ui-ux)[templates](https://forum.obsidian.md/tag/templates)

[Sep 13](https://forum.obsidian.md/t/guide-to-develop-and-execute-modular-javascript-in-obsidian/88339/1 "Jump to the first post")

[Sep 13](https://forum.obsidian.md/t/guide-to-develop-and-execute-modular-javascript-in-obsidian/88339/3)

[![](https://forum.obsidian.md/letter_avatar_proxy/v4/letter/m/ba8739/96.png)](https://forum.obsidian.md/u/Milleras)

[Milleras](https://forum.obsidian.md/u/Milleras)

[Sep 13](https://forum.obsidian.md/t/guide-to-develop-and-execute-modular-javascript-in-obsidian/88339 "Post date")
...
- **macros** : these classes act as an interface between the modules and the markdown files, and their main role is to render in HTML. Their functions are invoked in the pages using the [CustomJS plugin 42](https://github.com/saml-dev/obsidian-custom-js).
...
- the Obsidian [_CustomJS_ 42](https://github.com/saml-dev/obsidian-custom-js) plugin for externalizing JavaScript code and calling it.
...
- the environment [NodeJS 4](https://docs.npmjs.com/downloading-and-installing-node-js-and-npm) (optional but recommended to take advantage of the auto-completion of the Obsidian API in the IDE).
...
Writing all the JavaScript code only in markdown files will quickly make your files unreadable, and above all, make code maintenance difficult and lead to a lot of redundancy. That’s why it’s recommended that you move it to script files located in a subfolder of the Obsidian vault, then invoke them in the markdown pages using the [CustomJS plugin 42](https://github.com/saml-dev/obsidian-custom-js).
...
Secondly, the CustomJS plugin gives access to [two objects 42](https://github.com/saml-dev/obsidian-custom-js) which are essential for interacting with Obsidian:

- `customJS.obsidian`: provides access to the [Obsidian API 4](https://github.com/obsidianmd/obsidian-api/blob/master/obsidian.d.ts).
...
Writing JavaScript code in a simple text editor will quickly become tedious and be the source of many syntax errors without a checking tool. The advantage of an IDE such as [Visual Studio Code for JavaScript 1](https://code.visualstudio.com/docs/languages/javascript) is that it offers syntax highlighting, but above all **[auto-completion 1](https://en.wikipedia.org/wiki/Autocomplete) mechanisms** that will save you a huge amount of time.

The procedure for **configuring the development environment** is as follows:

1. From a terminal, install the NodeJS package of [`Obsidian API` 9](https://www.npmjs.com/package/obsidian).
...
**Module classes**, which are not intended to be used directly in markdown files, and which encapsulate the business logic and provide macros with their service functions. And **Macro classes**, which act as an interface between the modules and the markdown files using the [CustomJS plugin 42](https://github.com/saml-dev/obsidian-custom-js), and whose main role is to render HTML files.
...
### [](https://forum.obsidian.md/t/guide-to-develop-and-execute-modular-javascript-in-obsidian/88339#p-287455-script-macro-tags-of-pagesjs-with-the-macro-macrotagsofpage-3)Script `macro-tags-of-pages.js` with the macro `MacroTagsOfPage`

Before using this code, make sure you update the module search path in the `importModule()` function.

macro-tags-of-pages.js

### [](https://forum.obsidian.md/t/guide-to-develop-and-execute-modular-javascript-in-obsidian/88339#p-287455-style-css-macrocss-containing-the-class-macro-tags-of-page-4)Style CSS `macro.css` containing the class `.macro-tags-of-page`
