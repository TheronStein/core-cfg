...
Use the [view mode](https://publish.obsidian.md/advanced-uri-doc/Concepts/Navigation+Parameters#view-mode) parameter to e.g. switch between reading and live preview mode.

Tip

Use the [open mode](https://publish.obsidian.md/advanced-uri-doc/Concepts/Navigation+Parameters#open-mode) parameter to open the file always in a new tab or in a new window.
...
|settings tab|settingid|Opens a settings tab by id, all plugins are supported. See [here](https://publish.obsidian.md/advanced-uri-doc/Actions/Settings+navigation) for a list of all available options||
