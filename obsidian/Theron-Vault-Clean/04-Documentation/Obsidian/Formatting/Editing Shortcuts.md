#Obisidan/TextEditor/ShortCuts

Learn how to use keyboard shortcuts to navigate and edit text in your notes. You can also define [custom hotkeys](https://help.obsidian.md/User+interface/Hotkeys).
