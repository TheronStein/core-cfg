## Basic[¶](https://s-blu.github.io/obsidian_dataview_example_vault/20%20Dataview%20Queries/Basic%20Task%20Queries/#basic "Permanent link")
...
## Variants[¶](https://s-blu.github.io/obsidian_dataview_example_vault/20%20Dataview%20Queries/Basic%20Task%20Queries/#variants "Permanent link")

### List only open tasks[¶](https://s-blu.github.io/obsidian_dataview_example_vault/20%20Dataview%20Queries/Basic%20Task%20Queries/#list-only-open-tasks "Permanent link")
...
### Group tasks by file[¶](https://s-blu.github.io/obsidian_dataview_example_vault/20%20Dataview%20Queries/Basic%20Task%20Queries/#group-tasks-by-file "Permanent link")
...
### Show tasks that have a certain tag[¶](https://s-blu.github.io/obsidian_dataview_example_vault/20%20Dataview%20Queries/Basic%20Task%20Queries/#show-tasks-that-have-a-certain-tag "Permanent link")
...
### Show tasks with a due date (a task-located meta data field)[¶](https://s-blu.github.io/obsidian_dataview_example_vault/20%20Dataview%20Queries/Basic%20Task%20Queries/#show-tasks-with-a-due-date-a-task-located-meta-data-field "Permanent link")
...
### Sort task after completion date[¶](https://s-blu.github.io/obsidian_dataview_example_vault/20%20Dataview%20Queries/Basic%20Task%20Queries/#sort-task-after-completion-date "Permanent link")
...
![500](https://s-blu.github.io/obsidian_dataview_example_vault/00%20Meta/attachments/Basic_Task_Queries_completion_screenshot.png)  
...
Do you want to see more advanced examples? Head over to the [Query Type Overview](https://s-blu.github.io/obsidian_dataview_example_vault/30%20Dataview%20Resources/31%20Query%20Overviews/Queries%20by%20Type/#task) to see all available TASK queries in the vault!