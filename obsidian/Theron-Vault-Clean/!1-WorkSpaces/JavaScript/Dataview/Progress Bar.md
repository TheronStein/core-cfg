...
## Basic[¶](https://s-blu.github.io/obsidian_dataview_example_vault/20%20Dataview%20Queries/Render%20a%20progress%20bar/#basic "Permanent link")

`$= const value = Math.round((dv.current().pagesRead / dv.current().totalPages) * 100); "<progress value='" + value + "' max='100'></progress>" + " " + value + "%"`

## Variants[¶](https://s-blu.github.io/obsidian_dataview_example_vault/20%20Dataview%20Queries/Render%20a%20progress%20bar/#variants "Permanent link")

### Calculate progress of task completion for current file[¶](https://s-blu.github.io/obsidian_dataview_example_vault/20%20Dataview%20Queries/Render%20a%20progress%20bar/#calculate-progress-of-task-completion-for-current-file "Permanent link")
...
### Rendering progress bar directly in tables or list[¶](https://s-blu.github.io/obsidian_dataview_example_vault/20%20Dataview%20Queries/Render%20a%20progress%20bar/#rendering-progress-bar-directly-in-tables-or-list "Permanent link")
...
### Rendering custom styled progress bar directly in tables or list[¶](https://s-blu.github.io/obsidian_dataview_example_vault/20%20Dataview%20Queries/Render%20a%20progress%20bar/#rendering-custom-styled-progress-bar-directly-in-tables-or-list "Permanent link")
...
### Rendering a progress bar that is stored inside a field on the source file[¶](https://s-blu.github.io/obsidian_dataview_example_vault/20%20Dataview%20Queries/Render%20a%20progress%20bar/#rendering-a-progress-bar-that-is-stored-inside-a-field-on-the-source-file "Permanent link")
...
### Render a progress bar with additional textual information[¶](https://s-blu.github.io/obsidian_dataview_example_vault/20%20Dataview%20Queries/Render%20a%20progress%20bar/#render-a-progress-bar-with-additional-textual-information "Permanent link")
