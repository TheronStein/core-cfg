...
NERDFONT_ICONS_DIR = HOME / ".core/cfg/wezterm/scripts/nerdfont-browser/nerdfont-icons"
OUTPUT = HOME / ".core/cfg/wezterm/scripts/nerdfont-browser/data/icon-glyphs.txt"
