...
tmux display-menu -x C -y C -T "#[fg=#94e2d5,bold]󱂬 Popup Applications " \
  ...
  "" \
  " File Explorer" f "display-popup -E -w 90% -h 90% -T ' Yazi ' yazi" \
  ...
  " Nerd Fonts" n "display-popup -E -w 90% -h 90% -T ' Nerd Fonts ' '~/.core/.sys/cfg/wezterm/scripts/nerdfont-browser/wezterm-browser.sh'"
