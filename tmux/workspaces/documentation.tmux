...
# ============================================================================
# This is a server-specific tmux configuration for the 'documentation' server.
#
# Usage:
#   tmux -f $TMUX_CONF/workspaces/documentation.tmux -L documentation new-session
#
# This will:
#   - Load all base tmux.conf settings
#   - Use a separate resurrect directory: ~/.tmux/resurrect/documentation/
...
set-environment -g TMUX_SERVER_NAME "documentation"
set-environment -g TMUX_WORKSPACE_DISPLAY "Docs"
...
set -g @resurrect-dir "~/.tmux/resurrect/documentation"
...
# ============================================================================
# Documentation Server Keybindings (Optional Overrides)
# ============================================================================
...
# set -g status-left "#[fg=cyan,bold][ DOCS ]#[default] "
...
# new-session -d -s docs-main -c "$HOME/.core/.cortex"
