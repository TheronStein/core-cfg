...
-- Usage: wezterm --config-file modules/menus/tmux-theme-browser/generate-themes-data.lua

local wezterm = require("wezterm")
local home = os.getenv("HOME")

-- Output file
local data_dir = home .. "/.core/.sys/configs/wezterm/modules/menus/tmux-theme-browser/data"
