...
-- Usage: wezterm --config-file modules/menus/theme-browser/generate-themes-data.lua

local wezterm = require("wezterm")
local home = os.getenv("HOME")

-- Output file
local data_dir = home .. "/.core/.sys/configs/wezterm/modules/menus/theme-browser/data"
