...
local bookmarks = safe_require("modules.bookmarks")
local tab_rename = safe_require("modules.tab_rename")
local tab_tmux_browser = safe_require("modules.tab_tmux_browser")
