...
function M.setup(config)
	...
	local success, tabline = pcall(require, "tabline")
	...
	local preserved_theme = require("tabline.tabline_theme_preserved")
	...
	local tabline_success, err = pcall(function()
		tabline.setup({
			...
			sections = {
				...
				tabline_x = { "autosave_timer", "local_storage" },
				tabline_y = { "github" },
				tabline_z = { "domain" },
			},
