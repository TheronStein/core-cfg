...
Tag Hints, will show up whenever you need to input or select tag(s). Only custom Icons or colors are shown.

    image

    Tag Icon/Text/Hidden Indicator:

    Recording 2025-03-29 at 20 49 49

    Toggle Tag(s):

    Recording 2025-03-29 at 21 10 38

    Add, Remove, Replace, Edit Tag(s):

    Recording 2025-03-29 at 21 30 13

    Filter Files by Tag(s) and Modes: In all of examples below, I didn't use fixed tag keys with --keys/--key/--tag/--tags

        Mode = and (Default), match all of the selected tags:

        Recording 2025-03-29 at 20 56 47

        Mode = or, match at least one of the selected tags:

        Recording 2025-03-29 at 21 01 39

    Visual Selection Modes: In all of examples below, I didn't use fixed tag keys with --keys/--key/--tag/--tags

    image

        Replace selection:

        Recording 2025-03-29 at 23 30 56

        Unite selection:

        Recording 2025-03-29 at 23 36 59

        Subtract selection:

        Recording 2025-03-29 at 23 45 42

        Intersect selection:

        Recording 2025-03-29 at 23 51 17

        Exclude selection:

        Recording 2025-08-06 at 16 31 31

        Undo selection:

        Recording 2025-03-29 at 23 54 55
...
Ensure there are no conflicts with default Keybindings.
...
To modify the tag hints window appearance, edit .../yazi/theme.toml: You can also use Flavors file instead.
...
local files*to_clear_tags = selected_or_hovered_files()
for *, url in ipairs(files_to_clear_tags) do
