[boydaihungst/restore.yazi: Undo/Recover trashed files/folders](https://github.com/boydaihungst/restore.yazi)

# restore.yazi

[](https://github.com/boydaihungst/restore.yazi#restoreyazi)

- [restore.yazi](https://github.com/boydaihungst/restore.yazi#restoreyazi)
    - [Requirements](https://github.com/boydaihungst/restore.yazi#requirements)
    - [Installation](https://github.com/boydaihungst/restore.yazi#installation)
        - [Linux](https://github.com/boydaihungst/restore.yazi#linux)
    - [Usage](https://github.com/boydaihungst/restore.yazi#usage)

[Yazi](https://github.com/sxyazi/yazi) plugin to restore/recover latest deleted files/folders.

## Requirements

[](https://github.com/boydaihungst/restore.yazi#requirements)

- [yazi &gt;= v25.5.31](https://github.com/sxyazi/yazi)
- [trash-cli](https://github.com/andreafrancia/trash-cli)
    - If you have `Can't Get Trash Directory` error and running `trash-cli --volumes` in terminal throw `AttributeError: 'PrintVolumesList' object has no attribute 'run_action'`. Remove the old version of trash-cli and install newer version [How to install](https://github.com/andreafrancia/trash-cli?tab=readme-ov-file#the-easy-way).

## Installation

[](https://github.com/boydaihungst/restore.yazi#installation)

### Linux

[](https://github.com/boydaihungst/restore.yazi#linux)

ya pkg add boydaihungst/restore

## Usage

[](https://github.com/boydaihungst/restore.yazi#usage)

Important

This plugin restores files and folders based on their deletion date and time. However, since Yazi deletes files in batches of approximately 1000~2000, not all files in a large selection will have the same deletion timestamp. For example, if you select and delete 10,000 files, each batch of 1000~2000 may have a different deletion time. This can result in only a partial restoration of your files (in the worst case, only the last 1000~2000 files deleted). To resolve this, you may need to run the "restore" command multiple times until all desired files are recovered. For instance, to restore 10,000 files, you might have to execute the command up to 10 times.

1. Key binding
    
    - Add this to your `keymap.toml`. Make it doesn't override other keymaps. [Read more about keymap](https://yazi-rs.github.io/docs/configuration/keymap):
...
- Default:
    ...
    require("restore"):setup({
        ...
        suppress\_success\_notification = true,  -- Optional
