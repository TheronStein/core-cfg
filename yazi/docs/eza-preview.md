[ahkohd/eza-preview.yazi: Yazi plugin to preview directories using eza](https://github.com/ahkohd/eza-preview.yazi)

# eza-preview.yazi

[](https://github.com/ahkohd/eza-preview.yazi#eza-previewyazi)
...
List mode: [![list.png](https://github.com/ahkohd/eza-preview.yazi/raw/main/list.png)](https://github.com/ahkohd/eza-preview.yazi/blob/main/list.png)

Tree mode: [![tree.png](https://github.com/ahkohd/eza-preview.yazi/raw/main/tree.png)](https://github.com/ahkohd/eza-preview.yazi/blob/main/tree.png)

## Requirements

[](https://github.com/ahkohd/eza-preview.yazi#requirements)
...
[](https://github.com/ahkohd/eza-preview.yazi#installation)

ya pack -a ahkohd/eza-preview

## Usage

[](https://github.com/ahkohd/eza-preview.yazi#usage)

### Basic Setup

[](https://github.com/ahkohd/eza-preview.yazi#basic-setup)
...
[](https://github.com/ahkohd/eza-preview.yazi#key-bindings)
...
[](https://github.com/ahkohd/eza-preview.yazi#configuration)
...
require("eza-preview"):setup({
  ...
  -- ignore_glob = "*.log"
  -- ignore\_glob = { "*.tmp", "node\_modules", ".git", ".DS_Store" }
...
[](https://github.com/ahkohd/eza-preview.yazi#available-commands)
...
[](https://github.com/ahkohd/eza-preview.yazi#contributing)

Feel free to contribute by opening issues or submitting pull requests!

## License

[](https://github.com/ahkohd/eza-preview.yazi#license)

This project is licensed under the MIT License - see the [LICENSE](https://github.com/ahkohd/eza-preview.yazi/blob/main/LICENSE) file for details.
