...
[](https://github.com/dedukun/bookmarks.yazi#bookmarksyazi)
...
[](https://github.com/dedukun/bookmarks.yazi#requirements)

- [Yazi](https://github.com/sxyazi/yazi) v25.4.8+

## Features

[](https://github.com/dedukun/bookmarks.yazi#features)
...
[](https://github.com/dedukun/bookmarks.yazi#installation)

ya pkg add dedukun/bookmarks

## Import/Export bookmarks

[](https://github.com/dedukun/bookmarks.yazi#importexport-bookmarks)

This plugin uses [Yazi's DDS](https://yazi-rs.github.io/docs/dds/) for bookmark persistence, as such, the bookmarks are saved in DDS's state file (`~/.local/state/yazi/.dds` on Linux and `C:\Users\USERNAME\AppData\Roaming\yazi\state\.dds` on Windows)
...
[](https://github.com/dedukun/bookmarks.yazi#configuration)
...
require("bookmarks"):setup({
	...
	persist = "none",
	desc_format = "full",
	file\_pick\_mode = "hover",
	custom\_desc\_input = false,
	show_keys = false,
	notify = {
		enable = false,
		timeout = 1,
...
[](https://github.com/dedukun/bookmarks.yazi#last_directory)
...
[](https://github.com/dedukun/bookmarks.yazi#persist)
...
[](https://github.com/dedukun/bookmarks.yazi#desc_format)
...
[](https://github.com/dedukun/bookmarks.yazi#file_pick_mode)
...
[](https://github.com/dedukun/bookmarks.yazi#notify)
...
[](https://github.com/dedukun/bookmarks.yazi#custom_desc_input)
...
[](https://github.com/dedukun/bookmarks.yazi#show_keys)
