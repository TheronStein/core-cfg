...
# rmlint was executed from: $CORE_CFG/yazi/logs/rmlint-20251111-115849/
# Your command line was: rmlint --progress --with-color -T df -g -S a --hidden --keep-all-untagged -o pretty -o sh:rmlint.sh -o json:rmlint.json /home/theron/mnt/cachyos/Dropbox
...
Rmlint was executed in the following way:
   ...
   $ rmlint --progress --with-color -T df -g -S a --hidden --keep-all-untagged -o pretty -o sh:rmlint.sh -o json:rmlint.json /home/theron/mnt/cachyos/Dropbox
...
then                                           
  ...
  rm -f '$CORE_CFG/yazi/logs/rmlint-20251111-115849/rmlint.sh';                                     
fi                                             
