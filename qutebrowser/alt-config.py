...
c.url.start_pages = ["https://candy.ai"]
c.url.default_page = "https://pornpics.com"

# Search engines - use :open <shortcut> <query>
c.url.searchengines = {
    "DEFAULT": "https://google.com/search?q={}",
    "pp": "https://pornpics.com/search?q={}",
    "g": "https://google.com/search?q={}",
}

# Downloads
c.downloads.location.directory = "~/SSD/.encrypt/Downloads"
...
# Force focus on window show
c.new_instance_open_target = "window"
c.new_instance_open_target_window = "last-focused"

# Auto-raise window
c.window.hide_decoration = False  # Keep decorations for proper focus

# Focus settings
c.auto_save.session = True
c.session.lazy_restore = False  # Load immediately for focus
...
config.bind("gsc", "open -t https://scorepass.com")
# config.bind("g", "open -t https://youtube.com")
...
if browser_instance == "l_browser":
    ...
    c.url.start_pages = ["https://scorepass.com"]
    ...
    c.colors.tabs.selected.odd.bg = purple
    c.url.start_pages = ["https://pornpics.com"]
